...
SOURCES = \
	__init__.py \
	cycling_facilities.py cycling_facilities_algorithm.py cycling_facilities_provider.py

PLUGINNAME = cycling_facilities
...
QGISDIR=C:\Users\eleonore.lagourgue\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
